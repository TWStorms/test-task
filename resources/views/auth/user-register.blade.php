            ...
            <div class="container py-5 px-5 px-md-0">
                <div class="row">
                    ...
                    <div class="col-md-8 login-sec rounded-sm py-4 px-5 screen_set"  style="background-color :rgb(139, 106, 250);   box-shadow: 1px 3px 5px rgb(0 0 0 / 20%);"   >
                        ...
                        <form method="POST" class="ajaxRequest" id="complete-user-signup" action="{{ route('create.blogger') }}"
                              autocomplete="off">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col py-2"><input type="text" class="form-control" name="first_name" placeholder="First Name" required="required"></div>
                                    <div class="col py-2"><input type="text" class="form-control" name="last_name" placeholder="Last Name" required="required"></div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row">
                            ...
                            <div class="form-group text-white">
                                ...
                                <div class="form-check py-2 d-flex justify-content-md-end justify-content-center">
                                    <button type="submit" class="btn btn-outline-white rounded-pill  text-white btn_forgot" data-mdb-ripple-color="dark" >
                                        {{ __('Signup') }} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                        ...
                        <div class="text-white py-3">
                            Have An Account ? <a href="{{route('login')}}" style="text-decoration: none; color: #F9FBF2;">LogIn</a>
                        </div>
                    </div>
                </div>
            </div>
