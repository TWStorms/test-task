        ...
        <div class="row" style="height: 100vh;">
            ...
            <div class="card col" style="border: none; border-radius:20px; position: relative; margin-top: 10px;">
                <div class="card-header" style="border: none; background-color: mediumpurple;">
                    <h2 class="text-center" style="font-family: 'Nunito', sans-serif; color: white; background-color: mediumpurple;"><strong>{!! __('Transactions') !!}</strong></h2>
                </div>
                <div>
                    <p>
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="card card-body" style="margin-left: 10px;">
                            @include("super-admin.transaction.partials.__filters")
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col render">
                            @include('super-admin.transaction.partials._listing')
                        </div>
                    </div>
                </div>
            </div>
