<div class="mb-3">
    ...
    'method' => 'get', 'class' => 'ajaxSearch', 'reset' => 'false',
     'url' => route('super-admin.transactions')]) !!}
    <div>
        <div class="row">
            ...
            <div class="col-md-4 mt-3">
                <div class="row">
                    <div class="col-md-12 pr-0">
                        ...
                        <a class="btn custom-reset-btn" style="color:white;background-color: mediumpurple;" href="{{ route('super-admin.transactions') }}" style="width: 47%">
                            {!! __('Reset') !!}
                        </a>
                    </div>
                </div>
