...
@section('content')
    <div class="container-fluid" style="{{Auth::user()->status != \App\Helpers\IUserStatus::ACTIVE ? 'filter: blur(20px)' : ''}};">
        <div class="row" style="height: 100vh;">
            ...
            @if(Auth::user()->status == \App\Helpers\IUserStatus::ACTIVE)
                @include('supervisor.mobile-navbar')
            @endif
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card-header" style="border: none; background-color: mediumpurple;">
                            <h2 class="text-center" style="font-family: 'Nunito', sans-serif; color: white; background-color: mediumpurple;"><strong>{!! __('Edit Blog') !!}</strong></h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col render table-responsive">
                            @include('blogger.blog.partials.edit-form')
                        </div>
                    </div>
                </div>
            </div>
