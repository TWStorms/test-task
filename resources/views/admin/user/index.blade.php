...
@section('content')
    <div class="container-fluid" style="{{Auth::user()->status != \App\Helpers\IUserStatus::ACTIVE ? 'filter: blur(20px)' : ''}};">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card-header" style="border: none; background-color: mediumpurple;">
                            <h2 class="text-center" style="font-family: 'Nunito', sans-serif; color: white; background-color: mediumpurple;"><strong>{!! __('Users') !!}</strong></h2>
                        </div>
                    </div>
                </div>
                <div class="mt-2">
                    <a class="btn text-white" style="background-color: mediumpurple;" onclick="activate()">Create Supervisor</a>
                </div>

                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col render table-responsive">
                            @include('admin.user.partials._listing')
                        </div>
                    </div>
                </div>
            </div>
        ...
        @include('admin.user.partials.create-supervisor-modal')
