<div class="mb-3">
    ...
    <div>
        <div class="row">
            ...
            <div class="col-md-3 mt-3">
                {!! Form::select('withdrawal_request_status',[ '1' => 'Pending', '2' => 'Approved', '3' => 'Declined'], null, ['id' => 'withdrawal_request_status', 'class' => 'form-control', 'placeholder' => __('Select Status')]) !!}
            </div>
