...
@section('content')
        ...
        <div class="row" style="height: 100vh;">
            ...
            <div class="card col" style="border: none; border-radius:20px; position: relative; margin-top: 10px;">
                <div class="card-header" style="border: none; background-color: mediumpurple;">
                    <h2 class="text-center" style="font-family: 'Nunito', sans-serif; color: white; background-color: mediumpurple;"><strong>{!! __('Withdrawal Requests') !!}</strong></h2>
                </div>
                <div>
                    <p>
                        ...
                        <button class="btn ml-2 mt-3" style="color:white;background-color: mediumpurple;" data-toggle="modal" data-target="#withdrawAmountModal">
                            Withdraw Amount
                        </button>
                    </p>
                    <div class="collapse" id="collapseExample">
                        <div class="card card-body" style="margin-left: 10px;">
                            @include("user.withdrawal-request.partials.__filters")
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col render">
                            @include('user.withdrawal-request.partials._listing')
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('user.withdrawal-request.partials.withdraw-amount-modal')
    {{--</div>--}}
@endsection
